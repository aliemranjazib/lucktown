...
class SettingsSetNewPasswordPage extends StatefulWidget {
  final SeetingTokenAndOtp? tokenAndOtp;
  const SettingsSetNewPasswordPage({super.key, this.tokenAndOtp});

  @override
  State<SettingsSetNewPasswordPage> createState() =>
      _SettingsSetNewPasswordPageState();
}

class _SettingsSetNewPasswordPageState
    extends State<SettingsSetNewPasswordPage> {
